...
while True:
    ...
    cv2.putText(frame, "Emergency1: "+str(count['E1']), (10, 120), cv2.FONT_HERSHEY_PLAIN, 1, (0,0,0), 1)
    cv2.putText(frame, "Emergency2: "+str(count['E2']), (10, 140), cv2.FONT_HERSHEY_PLAIN, 1, (0,0,0), 1)
    cv2.putText(frame, "Normal_Emergency: "+str(count['NE']), (10, 160), cv2.FONT_HERSHEY_PLAIN, 1, (0,0,0), 1)
