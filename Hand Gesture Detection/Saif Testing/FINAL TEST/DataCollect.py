...
while True:
    ...
    cv2.putText(frame, "NORMAL : "+str(count['Hi']), (10, 120), cv2.FONT_HERSHEY_PLAIN, 1, (0,255,0), 1)
    cv2.putText(frame, "EMERGENCY O: "+str(count['Ok']), (10, 140), cv2.FONT_HERSHEY_PLAIN, 1, (0,255,0), 1)
    cv2.putText(frame, "EMERGENCY D : "+str(count['Like']), (10, 160), cv2.FONT_HERSHEY_PLAIN, 1, (0,255,0), 1)
    cv2.putText(frame, "HELP : "+str(count['Rock']), (10, 180), cv2.FONT_HERSHEY_PLAIN, 1, (0,255,0), 1)
